...
const getPendingVerifications = async (req, res) => {
  try {
    const result = await pool.query(`
      SELECT id, name, email, role, amazon_account, amazon_location, amazon_profile_url, paypal_account, facebook_account, whatsapp_account, telegram_account, verification_status,
